...
const appVersionSchema = new mongoose.Schema({
    ...
    minor: Number,
    patch: Number,
    appType: { type: String, enum: ["android_partner", "android_customer", "ios_customer", "message"] },
...
function validateAppVersionPost(version) {
    const schema = {
        ...
        appType: Joi.string().valid(["android_partner", "android_customer", "ios_customer", "message"]).required(),
